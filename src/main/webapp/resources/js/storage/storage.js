...
$(function(){	
	...
	*/
	...
	function createButton(id, text) {
        let buttonHtml = `<button class="ml-1 btn btn-outline-primary rounded-capsule mt-2" type="submit" id="${id}" style="margin-right:15px;">${text}</button>`;
