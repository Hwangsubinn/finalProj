		...
		<div class="card-body bg-light ">
			<form class="row g-3" modelAttribute="empRegisterVO" action="/emp/create" method="post">
				<div class="col-lg-6">
					...
					<input class="form-control" id="hrSdate" name="hrSdate" type="date" required>
				</div>
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<input class="form-control" id="empNm" name="empNm" type="text" value="" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="empMail">이메일</label>
					<input class="form-control" id="empMail" name="empMail" type="email" value="" required><span id="emailcheck"></span></input>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="empTelNo">전화번호</label>
					<input class="form-control" id="empTelNo" name="empTelNo" type="text" placeholder="숫자만 입력" required value="" maxlength='11' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
				</div>
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<input class="form-control" id="hrBank" name="hrBank" type="text" value="" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="hrBankNo">계좌번호</label>
					<input class="form-control" id="hrBankNo" name="hrBankNo" type="" required>
				</div>
