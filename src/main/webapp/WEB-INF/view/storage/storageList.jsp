          ...
          <c:url value="/stor" var="storUrl"/>
            <form action="${storUrl}" id="wareForm">	
				...
				<div class="mb-3 w-100">
				    ...
				    <div style="display: flex; align-items: center;">
					    <input type="text" name="wareAddr" id="sample4_roadAddress" class="form-control" />
					    <span id="guide" style="color:#999;display:none"></span>
					    <input type="button" onclick="sample4_execDaumPostcode()" value="주소 검색" style="padding: 6px 12px; border: 1px solid #ccc; background-color: #f0f0f0; color: #333; border-radius: 4px; cursor: pointer;"><br>
					</div>
				</div>
