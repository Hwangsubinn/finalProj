			...
			<ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
				<li class="nav-item">
					...
					<a class="nav-link dropdown-indicator" id="gugu"
						...
						aria-expanded="false" aria-controls="support-desk">
							<div class="d-flex align-items-center">
								<span class="fas fa-paste"  style="margin-right: 15px;"><span
					...
					<a class="nav-link dropdown-indicator"  id="gugu"
						...
						aria-expanded="false" aria-controls="support-desk">
						<div class="d-flex align-items-center">
							<span class="fas fa-coins"  style="margin-right: 15px;"><span
								class="fas fa-envelope-open"></span></span><span
					...
					<a class="nav-link dropdown-indicator" id="gugu"
						...
						aria-expanded="false" aria-controls="support-desk">
						<div class="d-flex align-items-center">
							<span class="fas fa-clipboard-list"  style="margin-right: 15px;"><span
				...
				<li class="nav-item">
					...
					aria-expanded="false" aria-controls="email">
						<div class="d-flex align-items-center">
							<span class="fas fa-dolly-flatbed"  style="margin-right: 15px;"><span
								class="fas fa-envelope-open"></span></span><span
					...
					aria-expanded="false" aria-controls="support-desk">
						<div class="d-flex align-items-center">
							<span class="fas fa-file-invoice-dollar" style="margin-right: 20px;"><span
								class="fas fa-ticket-alt"></span></span><span
					...
					aria-expanded="false" aria-controls="support-desk">
						<div class="d-flex align-items-center">
							<span class="fas fa-file-export" style="margin-right: 15px;"><span
								class="fas fa-ticket-alt"></span></span><span
				...
				<li class="nav-item">
					...
					aria-expanded="false" aria-controls="actInven" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-boxes" style="margin-right: 15px;"> <span
								class="fa-solid fa-cubes"></span>
					...
					aria-expanded="false" aria-controls="support-desk">
						<div class="d-flex align-items-center" id="gugu">
							<span class="far fa-file-excel" style="margin-right: 20px;"> <span
								class="fa-solid fa-dumpster"></span>
				...
				<li class="nav-item">
					...
					aria-expanded="false" aria-controls="support-desk" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-warehouse" style="margin-right: 15px;"><span
								class="fas fa-ticket-alt"></span></span><span
					...
					aria-expanded="false" aria-controls="support-desk" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-scroll" style="margin-right: 15px;"><span
								class="fas fa-ticket-alt"></span></span><span
					...
					aria-expanded="false" aria-controls="support-desk" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-file-import" style="margin-right: 15px;"><span
								class="fas fa-ticket-alt"></span></span><span
					...
					aria-controls="support-desk" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-box" style="margin-right: 15px;"><span
								class="fas fa-ticket-alt"></span></span><span
				...
				<li class="nav-item">
					...
					aria-controls="edsm" id="gugu">
						<div class="d-flex align-items-center">
							<span class="fas fa-money-check-alt"  style="margin-right: 15px;"> <span
				...
				<security:authorize access="hasRole('ADMIN')">
					<li class="nav-item">
						...
						aria-expanded="false" aria-controls="email" id="gugu">
							<div class="d-flex align-items-center">
								<span class="fas fa-bookmark"style="margin-right: 15px;"><span
									class="fas fa-envelope-open"></span></span><span
						...
						aria-expanded="false" aria-controls="support-desk" id="gugu">
							<div class="d-flex align-items-center">
								<span class="fas fa-cog" style="margin-right: 15px;"><span
									class="fas fa-ticket-alt"></span></span><span
